...
// less<int> denotes sorting in ascending order
typedef tree<int, null_type, less<int>, rb_tree_tag, tree_order_statistics_node_update> pbds;

// provides 2 more essential functionalities to a set:
// find_by_order(x): find xth element
// order_of_key(x): find number of elements smaller than x
